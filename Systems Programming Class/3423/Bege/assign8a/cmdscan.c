...
int cmdscan(char *cmdbuf, struct cmd *com)
{
  ...
  if ( (com->argv1[0] = strtok(cmdbuf," ") ) == NULL)
    return(-1);
  i = 1;
  while( (com->argv1[i++] = (token = strtok(NULL," "))) != NULL && strcmp(token,">") &&
  ...
  if ( token != NULL && strcmp(token,"|") == 0 )
    {
      com->piping = TRUE;
      i = 0;
      while( (com->argv2[i++] = (token = strtok(NULL," "))) != NULL && strcmp(token,">") &&
        strcmp(token,"<") && strcmp(token,">>") && strcmp(token,"&") && strcmp(token,"|") );
      com->argv2[i-1] = NULL;
      if ( com->argv2[0] == NULL )
        return(-1);
    ...
    if ( !strcmp(token,">") || !strcmp(token,">>") )
      {
        ...
        if ( (com->outfile = strtok(NULL," ")) == NULL )
          return(-1);
      } 
    else if ( !strcmp(token,"<") )
      {
        ...
        if ( (com->infile = strtok(NULL," ")) == NULL )
          return(-1);
      } 
    else if ( !strcmp(token,"|") )
      {
